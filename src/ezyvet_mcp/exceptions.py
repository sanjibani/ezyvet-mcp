"""ezyVet exceptions — typed hierarchy with structured context.
...
class EzyvetError(Exception):
    """Base exception for all ezyVet client errors.
...
class EzyvetNotFoundError(EzyvetError):
    """404 — resource doesn't exist or you don't have access."""

    http_status = 404


class EzyvetRateLimitError(EzyvetError):
...
class EzyvetConnectionError(EzyvetError):
